    ...
    <ScreenState error={error} loading={loading} offline={offline} empty={!data}>
      {data ? (
        <div className="mb-voice-page">
          ...
          <VoiceContour amplitude={amplitude} seed={data.persona_id} state="listening" />
          <CaptionStream language="" lines={data.lines} />
          <AudioClearedChip />
          <p>
            {data.model_caption}. Audio cleared in {data.audio_cleared_ms} ms.
          </p>
